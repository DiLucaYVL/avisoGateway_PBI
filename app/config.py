...
def parse_numbers(raw: str | None):
    if not raw:
        return []
    # aceita vírgula ou ponto-e-vírgula e remove espaços
    raw = raw.replace(";", ",")
...
EMAIL_TO = os.getenv("EMAIL_TO")  # pode ter múltiplos separados por vírgula/;
